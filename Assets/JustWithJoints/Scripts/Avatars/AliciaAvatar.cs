...
namespace JustWithJoints.Avatars
{
    public class AliciaAvatar : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            var rightUpLeg = hips.transform.Find("lowerbody").transform.Find("leg_R").gameObject;
            var rightLeg = rightUpLeg.transform.Find("knee_R").gameObject;
            var rightFoot = rightLeg.transform.Find("ankle_R").gameObject;
            var rightToeBase = rightFoot.transform.Find("toe_R").gameObject;
            var leftUpLeg = hips.transform.Find("lowerbody").transform.Find("leg_L").gameObject;
            var leftLeg = leftUpLeg.transform.Find("knee_L").gameObject;
            var leftFoot = leftLeg.transform.Find("ankle_L").gameObject;
            var leftToeBase = leftFoot.transform.Find("toe_L").gameObject;
